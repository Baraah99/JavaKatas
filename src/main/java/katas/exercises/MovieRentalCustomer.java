...
public class MovieRentalCustomer {
    ...
    public String htmlStatement() {
        double totalAmount = 0;
        int frequentRenterPoints = 0;
        StringBuilder result = new StringBuilder("<h1>Rental Record for <em>" + getName() + "</em></h1><table>");
        ...
        result.append("</table><p>Amount owed is <em>").append(totalAmount).append("</em></p>");
